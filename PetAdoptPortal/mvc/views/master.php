...
<body style="overflow-x: hidden;">
    <div class="container-fluid p-0" style="background: #4cf54c;position: fixed;z-index: 99">
        ...
        <div id="header" class="row m-0 p-4">
            ...
            <div id="menu__mobile" class="col-12 col-md-6 p-0" style="height: 40px;">
                <div  class="p-2" style="width: 55%;height: 40px;margin: auto;display: flex;">
                    <p class="font-weight-bold" style="width: 25%;"><a href="/PetAdoptPortal/index.php" style="text-decoration: none;color: black">Home</a></p>
                    
                    <p class="font-weight-bold" style="width: 25%"><a href="/PetAdoptPortal/mvc/views/pages/contact.php" style="text-decoration: none;color: black">Contact</a></p>
                    <p class="font-weight-bold" style="width: 25%" style="text-decoration: none;color: black"><a href="/PetAdoptPortal/mvc/views/pages/about.php" style="text-decoration: none;color: black">About</a></p>
                </div>
            </div>
